...
public class playerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1") &&    left_true)
        {
        ...
        if (right_true && Input.GetButtonDown("Fire1"))
            {   
        // if (Input.GetTouch("space")) { 
        {
            
       Rigidbody2D bomb = Instantiate(bullet2, transform.position, transform.rotation) as Rigidbody2D;
